...
client.on('ready', async () => {
  ...
  console.log(`Join the support server for get the code`)
  console.log(`https://discord.gg/drops`)
  console.log(`Join above`)
  client.user.setActivity(config.status.name, { type: config.status.type.toUpperCase(), url: "https://twitch.tv/aaaaaaaa" })
});
...
> \`${prefix}setstaff\` - set staff roles`)
      .setTimestamp()
      .setColor(`#33cd15`)
      .setFooter(`All rights belong to https://discord.gg/drops`)
